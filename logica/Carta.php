...
class Carta {
    ...
    public function consultar() {
        ...
        // Consultar datos básicos de la carta
        ...
        // Consultar platos asociados
        $conexion->ejecutar($cartaDAO->consultarPlatosDeCarta($this->id_carta));
        while($datosPlato = $conexion->registro()) {
            $plato = new Plato(
                $datosPlato[0], // id_plato
                $datosPlato[1], // nombre
                $datosPlato[2], // descripcion
                $datosPlato[3], // precio_base
                null,           // nivel_complejidad
                $datosPlato[4]  // foto
                );
            $this->agregarPlato($plato, $datosPlato[5]); // orden
        }

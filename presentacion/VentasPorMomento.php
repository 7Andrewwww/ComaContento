  ...
  <form method="get" class="row g-3 align-items-center">
    ...
    <div class="col-md-4">
      ...
      <?php if($añoFiltro || $mesFiltro): ?>
        <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="btn btn-outline-secondary mt-md-4 ms-2">Limpiar</a>
      <?php endif; ?>
    </div>
  </form>
</div>
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="mb-0">Ventas por Momento de Consumo</h3>
      </div>
      <div class="card-body">
